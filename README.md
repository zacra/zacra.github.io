...
GitHub는 개념과 기술 구조를 정리하는 공개 문서 허브이고,
가격·신청·최신 상품 안내는 위 네이버 공식 포스팅을 기준으로 관리합니다.

## 증권사 공통모듈과 AI 확장

Starter는 파이썬 자동매매 입문에 필요한 핵심 기능을 구현한 Lite 버전입니다.
패키지와 슈퍼 이동평균의 정식 공통모듈은 Starter보다 더 많은 기능을 포함하지만,
증권사 Open API가 제공하는 모든 기능을 전부 구현한 범용 SDK는 아닙니다.

게만아의 실제 전략에서 사용하는 기능을 중심으로 구현하며,
추가 기능이 필요하면 기존 공통모듈 + 증권사 공식 API 문서 + AI 코딩 도구로 확장할 수 있습니다.

- AI API 확장 가이드: https://zacra.github.io/ai-api-extension.html
- 제가 사용하는 Cursor 활용법: https://cafe.naver.com/pythonautogma/571
